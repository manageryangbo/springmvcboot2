...
//    static final Map<Class<?>, CacheKey> cacheKeyMap = InstanceUtil.newHashMap();
    ...
    /** 缓存命名空间 */
    static final String CACHE_NAMESPACE = "wastons:";
    /** 缓存命名空间 */
    static final String SYSTEM_CACHE_NAMESPACE = "S:wastons:";
    /** 缓存命名空间 */
    static final String CACHE_NAMESPACE_LOCK = "L:wastons:";
    /** 上次请求地址 */
    ...
    /** CACHE */
    static final String MYBATIS_CACHE = "D:wastons:MYBATIS:";
    /** 默认数据库密码加密key */
    static final String DB_KEY = "90139119";
    /** 临时目录 */
    static final String TEMP_DIR = "/temp/";
    /** 请求报文体 */
    static final String REQUEST_BODY = "wastons.requestBody";
