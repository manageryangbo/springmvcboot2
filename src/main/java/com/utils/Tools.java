...
public class Tools {
	...
	public static boolean isTelcom(String num) {
		if (num == null)
			return false;
        return num.length() > 7 && num.length() <= 12;
	}
	...
	public static String[][] vector2Ary(Vector<String[]> v, int clos) {
		...
		while (true) {
			try {
				str_return[int_loop] = v.elementAt(int_loop);
