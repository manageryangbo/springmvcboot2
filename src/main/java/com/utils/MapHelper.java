...
public class MapHelper {
    ...
    public static void main(String[] args) {
        ...
        double result1 = MapHelper.getDistance(31.2553210000, 121.4620020000, 31.2005470000, 121.3269970000);
        System.out.println(result1+"千米");

        /**
         * 第二种调用方法
         */
        double result2 = MapHelper.GetPointDistance("31.2553210000,121.4620020000", "31.2005470000,121.3269970000");
        System.out.println(result2+"千米");
